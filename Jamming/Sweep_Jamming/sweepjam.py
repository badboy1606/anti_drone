...
class sweepjam(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "sweepjam")
        ...
        self.blocks_vco_c_0 = blocks.vco_c(samp_rate, 20, 1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(5)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/lakshya/new.iq', False)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_waterfall_sink_x_0.set_frequency_range(02.4e9, self.samp_rate)
        self.qtgui_waterfall_sink_x_1.set_frequency_range(0, self.samp_rate)




def main(top_block_cls=sweepjam, options=None):
